    ...
    <header class="text-bg-dark sticky-top">
        <div class="d-flex align-items-center justify-content-around menudiv">
            ...
            <ul class="nav m-auto justify-content-center nav_list">
                ...
                <li class="nav_item"><a href="views/estabelecimentos.html" class="nav_link">Estabelecimentos</a></li>
                <li class="nav_item"><a href="views/sejamembro.html" class="nav_link">Seja Membro</a></li>
                <li class="nav_item"><a href="views/contato.html" class="nav_link">Contatos</a></li>
                <li class="nav_item"><a href="views/about.html" class="nav_link">Sobre</a></li>
            </ul>
                ...
                <div class="col-md-4 mb-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="link-para-estabelecimento1" class="btn btn-primary">Saiba Mais</a>
                        </div>
                    </div>
                </div>
                <!-- Estabelecimento 2 -->
                <div class="col-md-4 mb-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="link-para-estabelecimento2" class="btn btn-primary">Saiba Mais</a>
                        </div>
                    </div>
                </div>
                <!-- Estabelecimento 3 -->
                <div class="col-md-4 mb-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="link-para-estabelecimento3" class="btn btn-primary">Saiba Mais</a>
                        </div>
                    </div>
                </div>
            </div>

            <button id="load-more-btn" class="btn btn-primary load-more mb-5">Ver mais</button>
        </div>
    </div>
        ...
        <div class="row align-items-center g-lg-5 py-5">
            ...
            <div class="col-md-10 mx-auto col-lg-5">
                <form class="p-4 p-md-5 border rounded-3 bg-body-tertiary">
                    ...
                    <button class="w-100 btn btn-lg btn-primary" type="submit">Registar-se</button>
                    <hr class="my-4">
